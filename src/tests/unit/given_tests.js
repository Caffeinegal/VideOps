...
const {toVector, toPolarVector} = require('../../ts/math/polar-vector');
const {normalize, magnitude, lerp: vectorLerp, dot, add, subtract, mulFactor, distance} = require('../../ts/math/vector');
